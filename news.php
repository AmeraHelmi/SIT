...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body >
		...
		<a href="ara_newst.php" style="float:right;margin-top:-90px;font-size:18px;margin-right:150px;color:blue; "><b>Switch To Arabic</b></a> 		
		<div id="content" class="container_16 clearfix">
			<div class="grid_16">
				<center>
					<span title="click here to add new ">
						<a href="add_new.php" style="font-size:20px;color:red;text-decoration:none; margin-top: 20px;"><b>Add new </b></a>
					</span>
				</center>	
				<br/>
				<table>
