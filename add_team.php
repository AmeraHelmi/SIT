...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<a href="ara_add_team.php" style="float:right;margin-top:-90px;font-size:18px; margin-right:150px;color:blue;"><b>Switch To Arabic</b></a> 		
			...
			<div class="grid_16">
				<form method="post">
    				<table align="center">
    						...
    						<td align="center">
    							<center>
    								<span title="Click here to Team Page">
    									<a href="teams.php" style="font-size:20px;color:red;text-decoration:none"><b>Team</b></a>
    								</span>
    							</center>
    						</td>
    					</tr>
    					<tr>
    						<td>
    							<input type="text" style="font-size:22px" name="name" placeholder="Enter name of member" required />
    						</td>
    					</tr>
    					<tr>
    						<td>
    							<input type="text" style="font-size:22px"name="title" placeholder="Enter Title of member" required />
    						</td>
    					</tr>
      					<tr>
    						<td>
    							<input type="url" style="font-size:22px"name="fb" placeholder="Enter Facebook of member" />
    						</td>
    					</tr>
  						<tr>
    						<td>
    							<input type="url" style="font-size:22px"name="tw" placeholder="Enter Twitter of member"  />
    						</td>
    					</tr>
    					<tr>
							<td>
