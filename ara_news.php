<?php
	...
	{
 		$sql_query="DELETE FROM new WHERE id=".$_GET['delete_id'];
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body >
		...
		<a href="news.php" style="float:right;margin-top:-90px;margin-right:150px;font-size:18px;color:blue; "><b>الانتقال الى اللغة الانجليزية</b></a> 		
		<div id="content" class="container_16 clearfix">
			<div class="grid_16">
				<center>
					<span title="click here to add new ">
						<a href="ara_add_new.php" style="font-size:20px;color:red;text-decoration:none; margin-top: 20px;"><b>اضافة خبر جديد</b></a>
					</span>
				</center>	
				<br/>
				<table>
