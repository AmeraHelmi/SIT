...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<a href="ara_edit_project.php" style="float:right;margin-top:-90px;margin-right:150px;font-size:18px; color:blue;"><b>Switch To Arabic</b></a> 		
			...
			<form method="post">
    			<table align="center">
    				...
    				<tr>
   					...
   					<tr>
    					<td>
    						<input type="url" name="url" placeholder="<?php echo $fetched_row['url']; ?>" value="<?php echo $fetched_row['url']; ?>" required />
    					</td>
   					</tr>   
    				<tr>
    					<td>
