<?php
	...
	{
 		$sql_query="SELECT * FROM project WHERE id=".$_GET['edit_id'];
	...
	if(isset($_POST['btn-update']))
	{
 		...
 		$sql_query = "UPDATE project SET name='$name',description='$desc',url='$url' WHERE id=".$_GET['edit_id'];
...
?>
  	<script type="text/javascript">
  		...
  		window.location.href='ara_projects.php';
  	</script>
<?php
 	}
 	else
...
<?php
	...
	{
 		header("Location: ara_projects.php");
	}
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<script type="text/javascript">
			function edt_id(id)
			{
 				...
 				{
  					window.location.href='ara_edit_project.php?edit_id='+id;
 				}
			}
			function delete_id(id)
			{
 				...
 				{	
  					window.location.href='ara_projects.php?delete_id='+id;
 				}
			}	
		</script>
	</head>
	<body>
		...
		<a href="edit_project.php" style="float:right;margin-top:-90px;margin-right:150px;font-size:18px;color:blue; "><b>الانتقال الى اللغة الانجليزية</b></a> 		
			...
			<form method="post">
    			<table align="center">
    				...
    				<tr>
   					...
   					<tr>
    					<td>
    						<input type="url" name="url" style="direction: rtl; text-align: right;" placeholder="<?php echo $fetched_row['url']; ?>" value="<?php echo $fetched_row['url']; ?>" required />
    					</td>
   					</tr>   
    				<tr>
    					<td>
