...
<html lang="en">
    ...
    <body>
        ...
        <section id="logo-section" class="text-center">
            <div class="container">
           <a href="index.php" style="float:right;margin-bottom:20px;font-size:18px; "><b>الانتقال الى اللغة الانجليزية</b></a> 
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="modal-content">
                ...
                <div class="container">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="feature">
                                <!-- <i class="fa fa-magic"></i> -->
                                <div><img src="images/project.jpg"></div>
                                <div class="feature-content">
                                    <?php
                                        echo "<h3>".$row['name']."</h3> 
                                            <p>".$row['descrription'].
