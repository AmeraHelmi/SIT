...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<h1 id="head">
			...
			<a href="ara_add_service.php" style="float:right;margin-top:-90px;font-size:18px; margin-right:150px;color:blue;"><b>Switch To Arabic</b></a> 		
				...
				<div class="grid_16">
					<form method="post">
    					<table align="center">
    							...
    							<td align="center">
    								<center>
    									<span title="Click here to Services Page">
    										<a href="services.php" style="font-size:20px;color:red;text-decoration:none"><b>Services</b></a>
    									</span>
    								</center>
    							</td>
    						</tr>
    						<tr>
    							<td>
    								<input type="text" style="font-size:22px" name="name" placeholder="Enter name of service" required />
    							</td>
    						</tr>
    						<tr>
    							<td>
    								<input type="text" style="font-size:22px"name="description" placeholder="Enter description of service" required />
    							</td>
    						</tr>
    						<tr>
    							<td>
    								<input type="text" style="font-size:22px"name="type" placeholder="Enter type of service" required />
    							</td>
    						</tr>
