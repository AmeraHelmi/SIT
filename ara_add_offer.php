...
<a href="add_offer.php" style="float:right;margin-top:-90px;font-size:18px;color:blue;margin-right:150px; "><b>الانتقال الى اللغة الانجليزية</b></a> 		
			...
			<div class="grid_16">
				<form method="post">
    				<table align="center">
    						...
    						<td align="center">
    							<center>
    								<span title="Click here to Offers Page">
    									<a href="ara_admin.php" style="font-size:20px;color:red;text-decoration:none"><b>العروض</b></a>
    								</span>
    							</center>
    						</td>
					    </tr>
    					<tr>
    						<td>
    							<input type="text" style="direction: rtl; text-align: right;font-size:22px"name="name" placeholder="ادخل اسم العرض" required />
    						</td>
    					</tr>
    					<tr>
    						<td>
    							<input type="text" style="direction: rtl; text-align: right;font-size:22px"name="description" placeholder="ادخل وصف العرض" required />
    						</td>
    					</tr>
    					<tr>
    						<td>
