...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<ul id="navigation">
			...
			<li style="font-size:16px;"><a style="float:right;" href="ara_projects.php">المشارع</a></li>
			<li style="font-size:16px;"><a style="float:right;" href="ara_teams.php">الفريق</a></li>
			<li style="font-size:16px;"><span style="float:right;" class="active">اخرى</span></li>
            <li style="font-size:16px;"><a href=""></a></li>
		</ul>
<a href="others.php" style="float:right;margin-top:-90px;margin-right:150px;font-size:18px;color:blue; "><b>الانتقال الى اللغة الانجليزية</b></a>         
  ...
  if(empty($_POST['vision']))
                ...
                else
                {
 				...
 				// $sql_query = "INSERT INTO others(id,vision,mision,history,about_us,email,phone,mobile,web,tw,fb,linkedin,google,offer_desc,project_desc,team_desc,service_desc,new_desc) VALUES('','$vision','$mission','$history','$about','$email','$phone','$mobile','$web','$tw','$fb','$lin','$google','$offer_desc','$project_desc','$team_desc','$service_desc','$new_desc')";
 				$v=1;
...
?>
<script type="text/javascript">location.href = 'ara_admin.php';</script>
<?php
